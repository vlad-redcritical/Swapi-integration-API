...
import pl.softwareplant.api.client.hystrix.SwapiClientFallbackFactory;

@FeignClient(value = "swapiclient", url = "https://swapi.co/api", configuration = ClientConfig.class, fallbackFactory = SwapiClientFallbackFactory.class)
